...
contract NounsDAOLogicV2 is NounsDAOStorageV2, NounsDAOEventsV2 {
    ...
    function quorumVotes(uint256 proposalId) public view returns (uint256) {
        ...
        return dynamicQuorumVotes(
            proposal.againstVotes, proposal.totalSupply, getDynamicQuorumParamsAt(proposal.creationBlock)
        );
    }
     ...
     */
    function dynamicQuorumVotes(uint256 againstVotes, uint256 totalSupply, DynamicQuorumParams memory params)
        public
        pure
        returns (uint256)
    {

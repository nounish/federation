...
contract Manager is IManager, VersionedContract, UUPS, Ownable, ManagerStorageV1 {
    ...
    function deploy(
        ...
        daoAddressesByToken[token] =
            DAOAddresses({metadata: metadata, auction: auction, treasury: treasury, governor: governor});
    ...
    function getAddresses(address _token)
        public
        view
        returns (address metadata, address auction, address treasury, address governor)
    {
